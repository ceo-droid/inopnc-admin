...
export const SITE_COLOR_THEMES = [
  ...
  { header: 'bg-cyan-50/50 text-cyan-950 dark:bg-cyan-900/25 dark:text-cyan-100', border: 'border-cyan-200 dark:border-cyan-800' },
  ...
  { header: 'bg-teal-100/40 text-teal-950 dark:bg-teal-900/20 dark:text-teal-100', border: 'border-teal-200 dark:border-teal-800' },
