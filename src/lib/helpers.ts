...
export const SITE_COLOR_THEMES = [
  { header: 'bg-muted/65 text-foreground dark:bg-muted/60', border: 'border-border' },
  { header: 'bg-teal-50/55 text-teal-950 dark:bg-teal-400/18 dark:text-teal-100', border: 'border-teal-200 dark:border-teal-800' },
  { header: 'bg-slate-100/55 text-slate-900 dark:bg-slate-300/16 dark:text-slate-100', border: 'border-slate-300 dark:border-slate-700' },
  { header: 'bg-cyan-100/55 text-cyan-950 dark:bg-cyan-400/18 dark:text-cyan-100', border: 'border-cyan-200 dark:border-cyan-800' },
  { header: 'bg-emerald-50/50 text-emerald-950 dark:bg-emerald-400/18 dark:text-emerald-100', border: 'border-emerald-200 dark:border-emerald-800' },
  { header: 'bg-stone-100/55 text-stone-900 dark:bg-stone-300/16 dark:text-stone-100', border: 'border-stone-300 dark:border-stone-700' },
  { header: 'bg-zinc-100/55 text-zinc-900 dark:bg-zinc-300/16 dark:text-zinc-100', border: 'border-zinc-300 dark:border-zinc-700' },
  { header: 'bg-teal-100/50 text-teal-950 dark:bg-teal-300/16 dark:text-teal-100', border: 'border-teal-200 dark:border-teal-800' },
  { header: 'bg-gray-100/55 text-gray-900 dark:bg-gray-300/16 dark:text-gray-100', border: 'border-gray-300 dark:border-gray-700' },
];
